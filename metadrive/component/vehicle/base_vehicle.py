...
class BaseVehicle(BaseObject, BaseVehicleState):
    ...
    def _state_check(self):
        ...
        res = rect_region_detection(
            self.engine, self.position, np.rad2deg(self.heading_theta), self.LENGTH, self.WIDTH,
            CollisionGroup.Sidewalk, in_static_world=True if not self.render else False)
