...
from metadrive.component.pgblock.curve import Curve, CurveWithGuardrail
from metadrive.component.pgblock.straight import Straight, StraightWithGuardrail
...
if __name__ == "__main__":
    ...
    env = RacingEnv(config=Racing_config)
