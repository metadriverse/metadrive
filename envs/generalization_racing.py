...
import numpy as np
from world.chase_camera import ChaseCamera
import gym
...
from world.manual_controller import KeyboardController, JoystickController
from scene_manager.traffic_manager import TrafficManager, TrafficMode
from envs.observation_type import ArrayObservationType, GrayScaleObservation
...
class GeneralizationRacing(gym.Env):
    ...
    def default_config() -> PgConfig:
        env_config = dict(
            ...
            controller="keyboard",  # or "keyboard"
