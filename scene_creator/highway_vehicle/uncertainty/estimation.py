...
from city_drive.highway_env.vehicle.uncertainty.prediction import IntervalVehicle, Polytope
...
class MultipleModelVehicle(LinearVehicle):
    def __init__(
        ...
        super().__init__(
            road, position, heading, speed, target_lane_index, target_speed, route, enable_lane_change, timer, data
        )
        if not self.data:
            self.data = []
