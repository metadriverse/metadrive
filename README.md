<img align=right width=250px  src="metadrive/assets/MetaDrive.png" />
...
If you wish to contribute to this project or make some modification, you can clone the latest version of MetaDrive locally and install via:
